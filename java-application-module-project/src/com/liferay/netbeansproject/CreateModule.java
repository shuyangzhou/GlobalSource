	...
	private static void _appendImportSharedList(
		...
		if (!importSharedList.isEmpty()) {
			for (String module : importSharedList.split(":")) {
				List<String> moduleNameList = projectInfo.getModuleNameList();

				if (moduleNameList.contains(module)) {
					importShared.add(module);
				}

				for (String importSharedModule : moduleNameList) {
					Path path = Paths.get(importSharedModule);

					Path namePath = path.getFileName();

					String nameString = namePath.toString();

					if (nameString.equals(module)) {
	...
	private static class ProjectInfo {
		...
		private ProjectInfo(
			...
			for (String module : moduleList) {
				...
				_moduleNameList.add(nameString);
			}
		}
		...
		private final List<String> _moduleNameList;
