...
public class CommonTasks {
		...
		if (libFolder.exists()) {
			...
			for (File jar : libJars) {
				...
				if (jarName.equals("test")) {
					File[] testJars = jar.listFiles();

					for (File testJar : testJars) {
	...
	public static File modulePathFinder(String currentPath, String module) {
		...
		File[] childFiles = currentFile.listFiles(_directoryFileFilter);
		...
		for (File childFile : childFiles) {
			...
			if (!childFileName.equals("build") &&
				!childFileName.equals(
					"classes")&& !childFileName.equals(
						"lib")&& !childFileName.equals(
							"src")&& !childFileName.equals(
								"tmp")&& !childFileName.equals(
									"test")&& !childFileName.equals(
										"test-classes")) {
